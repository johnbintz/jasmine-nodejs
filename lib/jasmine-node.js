...
var jasminePath = path.join(path.dirname(__filename), "..", "vendor", "jasmine", "lib", "jasmine-0.10.4.js");
sys.puts("Loading jasmine from " + jasminePath);

var jscontent = fs.readFileSync(jasminePath);
Script.runInThisContext(jscontent, jasminePath);
...
exports.runDefaultNodeSpecs = function() {
  ...
  exports.includeAll("spec/*Spec.js");
  exports.includeAll("spec/**/*_spec.js");
  exports.includeAll("spec/**/*Spec.js");
